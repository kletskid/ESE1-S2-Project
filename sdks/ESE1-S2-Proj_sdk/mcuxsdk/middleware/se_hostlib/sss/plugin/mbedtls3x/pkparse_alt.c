...
//Oroginal line - if !defined(MBEDTLS_RSA_NO_CRT) && !defined(MBEDTLS_RSA_ALT)
/*
    Changing as the reference keys will fail here.
    Also a check to see if it is a reference key or not cannot be done
    as we have no access to QP.
*/
