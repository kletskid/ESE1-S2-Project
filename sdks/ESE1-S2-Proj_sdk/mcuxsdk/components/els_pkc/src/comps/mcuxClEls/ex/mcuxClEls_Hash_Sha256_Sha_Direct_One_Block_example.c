...
/**
 * @file  mcuxClEls_Hash_Sha256_Sha_Direct_One_Block_example.c
 * @brief Example of SHA2-256 hashing using sha direct mode of ELS (CLNS component mcuxClEls)
 *
 * @example mcuxClEls_Hash_Sha256_Sha_Direct_One_Block_example.c
 * @brief   Example of SHA2-256 hashing using sha direct mode of ELS (CLNS component mcuxClEls)
 */
...
MCUXCLEXAMPLE_FUNCTION(mcuxClEls_Hash_Sha256_Sha_Direct_One_Block_example)
{
