...
#define MCUXCLRANDOMMODES_CTR_DRBG_AES256_CONTEXT_SIZE ($(mcuxClRandomModes_Context_Aes256)u)
...
#ifdef MCUXCL_FEATURE_RANDOMMODES_SECSTRENGTH_256
#define MCUXCLRANDOMMODES_TESTMODE_CTR_DRBG_AES256_INIT_ENTROPY_SIZE     ($(mcuxClRandomModes_TestMode_CtrDrbg_Aes256_Entropy_Input_Init_size)u)
#define MCUXCLRANDOMMODES_TESTMODE_CTR_DRBG_AES256_RESEED_ENTROPY_SIZE   ($(mcuxClRandomModes_TestMode_CtrDrbg_Aes256_Entropy_Input_Reseed_size)u)
#endif // MCUXCL_FEATURE_RANDOMMODES_SECSTRENGTH_256
