...
/**
 * @file  mcuxClEcc_ECDSA_Deterministic_NIST_P521_example.c
 * @brief Example for the mcuxClEcc component
 *
 * @example mcuxClEcc_ECDSA_Deterministic_NIST_P521_example.c
 * @brief   Example for the mcuxClEcc component deterministic ECDSA signature generation using the test vectors
 *          from from Section A.2.6 of rfc 6979 (test case "With SHA-512, message = "sample"")
 */
...
/* Prime p of NIST P-521 as used in Section A.2.6 of rfc 6979 */
...
/* Base point order n of NIST P-521 as used in Section A.2.6 of rfc 6979 */
...
/* Curve parameter a of NIST P-521 as used in Section A.2.6 of rfc 6979 */
...
/* Curve parameter b of NIST P-521 as used in Section A.2.6 of rfc 6979 */
...
/* Base point of NIST P-521 as used in Section A.2.6 of rfc 6979 */
...
{
    /* private key = 0x00FAD06DAA62BA3B25D2FB40133DA757205DE67F5BB0018FEE8C86E1B68C7E75CA
     *                 A896EB32F1F47C70855836A6D16FCC1466F6D8FBEC67DB89EC0C08B0E996B83538 [BE] */
...
/* Input message taken from Section A.2.6 of rfc 6979 (test case "With SHA-512, message = "sample"") */
...
/* Reference signature taken from Section A.2.6 of rfc 6979 (test case "With SHA-512, message = "sample"") */
...
MCUXCLEXAMPLE_FUNCTION(mcuxClEcc_ECDSA_Deterministic_NIST_P521_example)
{
    ...
    ALIGNED uint8_t pHash[MCUXCLHASH_OUTPUT_SIZE_SHA_512];
    ...
    MCUXCLBUFFER_INIT_RO(buffA, NULL, pA, MCUXCLECC_WEIERECC_NIST_P521_SIZE_PRIMEP);
    MCUXCLBUFFER_INIT_RO(buffB, NULL, pB, MCUXCLECC_WEIERECC_NIST_P521_SIZE_PRIMEP);
    MCUXCLBUFFER_INIT_RO(buffP, NULL, pP, MCUXCLECC_WEIERECC_NIST_P521_SIZE_PRIMEP);
    MCUXCLBUFFER_INIT_RO(buffG, NULL, pG, MCUXCLECC_WEIERECC_NIST_P521_SIZE_PRIMEP * 2u);
    MCUXCLBUFFER_INIT_RO(buffN, NULL, pN, MCUXCLECC_WEIERECC_NIST_P521_SIZE_BASEPOINTORDER);
    ...
    params.curveParam.misc = mcuxClEcc_DomainParam_misc_Pack(MCUXCLECC_WEIERECC_NIST_P521_SIZE_BASEPOINTORDER, MCUXCLECC_WEIERECC_NIST_P521_SIZE_PRIMEP);
    params.pHash = buffHash;
    params.pPrivateKey = pPrivKey;
    params.pSignature = buffSignature;
    params.optLen = mcuxClEcc_Sign_Param_optLen_Pack(MCUXCLHASH_OUTPUT_SIZE_SHA_512);
